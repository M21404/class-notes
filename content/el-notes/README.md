...
│   │   │   ├── 6,500 new financial sector jobs in 2021 amid shortage of S'poreans to fill rising number of tech roles - TODAY
│   │   │   ├── _index.m
│   │   │   ├── Influencer marketing platform Partipost gets US$5m in extended Series A round - The Business Times
│   │   │   ├── To what extent has technology had a negative impact on the skill levels of people.m
│   │   │   ├── Two new SGUnited courses to help job seekers upgrade digitalisation skills - The Straits Times
│   │   │   ├── These local start-ups are making waves globally with their innovative AI solutions - and securing millions in funding along the way - The Business Times
│   │   │   ├── Singapore's game plan to court more billionaires to come here is paying off - CNA
│   │   │   ├── 'Tech-lite' roles in ICT sector also need to be filled - The Straits Times
│   │   │   ├── Google to open up 600 more slots under its digital-skills training programme - The Business Times
...
│   │   │   ├── Machine learning - a powerful tool in economics - The Straits Times
...
│   │   ├── In an age of rapid technological advancement, is a single career for life realistic.m
│   │   ├── CANCEL CULTURE
...
│   │   │   ├── Entertainment, not truth, is the priority of the media today, Comment.m
│   │   │   └── A Mass Murder of, and for, the Internet - The New York Times
│   │   ├── Technology should only be tolerated in so far as it aids the human condition - To what extent do you agree.m
...
│   │   │   ├── Is the protection of privacy worthwhile.m
│   │   │   ├── The Spying That Changed Big Tech - The New York Times
│   │   │   ├── India antitrust probe finds Google abused Android dominance, report shows - CNA
│   │   │   ├── Bill restricting police use of TraceTogether data introduced in Parliament, with tougher penalties for misuse - CNA
│   │   │   ├── How Mark Zuckerberg and Apple's C.E.O. Became Foes - The New York Times
...
│       ├── Covid-19
│       │   ├── Implications
│       │   │   ├── A future with Covid-19 - What would life look like - The Straits Times
│       │   │   ├── _index.m
│       │   │   ├── Securing Singapore's future in a changed world - The Straits Times
│       │   │   ├── COVID-19’s education revolution - where going digital is just half the battle - CNA
│       │   │   └── How will Covid-19 shape the way children see Singapore in future - TODAY
...
│       │   ├── First Covid, Then Psychosis ‘The Most Terrifying Thing I’ve Ever Experienced’ - The New York Times
│       │   ├── Hesitancy
...
│       ├── The danger of modern science is that instead of teaching mankind humility, it has made us supremely arrogant.m
│       └── People are placing too much faith in medical science. Do you agree.m
...
│   │   ├── The only way to end the class divide - the case for abolishing private schools - The Guardian
│   │   ├── Problem of social divide extends beyond the school - TODAY
│   │   └── Meritocracy
│   │       ├── Meritocracy still key principle for recognising individuals in Singapore - The Straits Times
│   │       ├── _index.m
│   │       ├── “The Meritocracy Trap,” explained - Vox
│   │       ├── How Life Became an Endless, Terrible Competition.m
│   │       └── Meritocracy and how to manage its downsides - The Straits Times
│   ├── How far is it possible to have a fair and inclusive society in your country.m
...
│   │   │   ├── Inspiration From A Rising Female Leader On Solving The STEM Gender Gap - Forbes
│   │   │   ├── _index.m
│   │   │   ├── Only 58% of women with Stem qualifications work in related jobs, compared with 70% for men - The Straits Times
│   │   │   ├── Programme to draw women to Stem fields, address talent 'leak'  - The Straits Times
│   │   │   ├── East Coast grant for women studying Stem - The Straits Times
...
│       ├── _index.m
│       └── Grappling with isolation, migrant workers in dorms long for a return to the wider community - CNA
└── tree.txt
